...
INSERT INTO `heroes` VALUES (1,'Ana',4,200,0,0,'Ana Amari',60,NULL,'Overwatch','Cairo, Egypt',3,'Ana’s versatile arsenal allows her to affect heroes all over the battlefield. Her Biotic Rifle rounds and Biotic Grenades heal allies and damage or impair enemies; her sidearm tranquilizes key targets, and Nano Boost gives one of her comrades a considerable increase in power.'),(2,'Bastion',2,200,100,0,'SST Laboratories Siege Automaton E54',30,220,NULL,NULL,1,'Repair protocols and the ability to transform between stationary Assault, mobile Recon and devastating Tank configurations provide Bastion with a high probability of victory.'),(3,'D.Va',3,100,400,0,'Hana Song',19,NULL,'Mobile Exo-Force of the Korean Army','Busan, South Korea',2,'D.Va’s mech is nimble and powerful—its twin Fusion Cannons blast away with autofire at short range, and she can use its Boosters to barrel over enemies and obstacles, or deflect attacks with her projectile-dismantling Defense Matrix.'),(4,'Genji',1,200,0,0,'Genji Shimada',35,NULL,'Shimada Clan','Shambali Monastery, Nepal',3,'Genji flings precise and deadly Shuriken at his targets, and uses his technologically-advanced katana to deflect projectiles or deliver a Swift Strike that cuts down enemies.'),(5,'Hanzo',2,200,0,0,'Hanzo Shimada',38,173,'Shimada Clan','Hanamura, Japan',3,'Hanzo’s versatile arrows can reveal his enemies or fragment to strike multiple targets. He can scale walls to fire his bow from on high, or summon a titanic spirit dragon.'),(6,'Junkrat',2,200,0,0,'Jamison Fawkes',25,195,'Junkers','Junkertown, Australia',2,'Junkrat’s area-denying armaments include a Frag Launcher that lobs bouncing grenades, Concussion Mines that send enemies flying, and Steel Traps that stop foes dead in their tracks.'),(7,'Lúcio',4,200,0,0,'Lúcio Correia dos Santos',26,160,NULL,'Rio de Janeiro, Brazil',2,'On the battlefield, Lúcio’s cutting-edge Sonic Amplifier buffets enemies with projectiles and knocks foes back with blasts of sound. His songs can both heal his team or boost their movement speed, and he can switch between tracks on the fly.'),(8,'McCree',1,200,0,0,'Jesse McCree',37,185,'Deadlock Gang','Santa Fe, New Mexico',2,'Armed with his Peacekeeper revolver, McCree takes out targets with deadeye precision and dives out of danger with eagle-like speed.'),(9,'Mei',2,250,0,0,'Mei-Link Zhou',31,160,'Overwatch','Xi\'an, China',3,'Mei’s weather-altering devices slow opponents and protect locations. Her Endothermic Blaster unleashes damaging icicles and frost streams, and she can Cryo-Freeze herself to guard against counterattacks, or obstruct the opposing team\'s movements with an Ice Wall.'),(10,'Mercy',4,200,0,0,'Angela Ziegler',37,170,'Overwatch','Zürich, Switzerland',1,'Mercy’s Valkyrie Suit helps keep her close to teammates like a guardian angel; healing, resurrecting or strengthening them with the beams emanating from her Caduceus Staff.'),(11,'Pharah',1,200,0,0,'Fareeha Amari',32,180,'Helix Security International','Giza, Egypt',1,'Soaring through the air in her combat armor, and armed with a launcher that lays down high-explosive rockets, Pharah is a force to be reckoned with.'),(12,'Reaper',1,250,0,0,'Gabriel Reyes',56,185,'Overwatch','Los Angeles, California, United States of America',1,'Hellfire Shotguns, the ghostly ability to become immune to damage, and the power to step between shadows make Reaper one of the deadliest beings on Earth.'),(13,'Reinhardt',3,300,200,0,'Reinhardt Wilhelm',61,223,'Overwatch','Stuttgart, Germany',1,'Clad in powered armor and swinging his hammer, Reinhardt leads a rocket-propelled charge across the battleground and defends his squadmates with a massive energy barrier.'),(14,'Roadhog',3,600,0,0,'Mako Rutledge',48,220,'Australian Liberation Front','Junkertown, Australia',1,'Roadhog uses his signature Chain Hook to pull his enemies close before shredding them with blasts from his Scrap Gun. He’s hardy enough to withstand tremendous damage, and can recover his health with a short breather.'),(15,'Soldier: 76',1,200,0,0,'Jack Morrison',55,185,'Overwatch',NULL,1,'Armed with cutting-edge weaponry, including an experimental pulse rifle that’s capable of firing spirals of high-powered Helix Rockets, Soldier: 76 has the speed and support know-how of a highly trained warrior.'),(16,'Symmetra',4,100,0,0,'Satya Vaswani',28,170,'Vishkar Corporation','Utopaea, India',2,'Symmetra utilizes her light-bending Photon Projector to dispatch adversaries, shield her associates, construct teleportation pads and deploy particle-blasting Sentry Turrets.'),(17,'Torbjörn',2,200,0,0,'Torbjörn Lindholm',57,140,'Overwatch','Gothenburg, Sweden',2,'Torbjörn’s extensive arsenal includes a rivet gun and hammer, as well as a personal forge that he can use to build upgradeable turrets and dole out protective armor packs.'),(18,'Tracer',1,150,0,0,'Lena Oxton',26,162,'Overwatch','London, England',2,'Toting twin pulse pistols, energy-based time bombs, and rapid-fire banter, Tracer is able to \"blink\" through space and rewind her personal timeline as she battles to right wrongs the world over.'),(19,'Widowmaker',2,200,0,0,'Amélie Lacroix',33,175,'Talon','Annecy, France',2,'Widowmaker equips herself with whatever it takes to eliminate her targets, including mines that dispense poisonous gas, a visor that grants her squad infra-sight, and a powerful sniper rifle that can fire in fully-automatic mode.'),(20,'Winston',3,400,100,0,'Winston',29,220,'Overwatch','Watchpoint Gibraltar',2,'Winston wields impressive inventions—a jump pack, electricity-blasting Tesla Cannon, portable shield projector and more—with literal gorilla strength.'),(21,'Zarya',3,200,0,200,'Aleksandra Zaryanova',28,195,'Russian Defense Forces','Krasnoyarsk Front, Russia',3,'Deploying powerful personal barriers that convert incoming damage into energy for her massive Particle Cannon, Zarya is an invaluable asset on the front lines of any battle.'),(22,'Zenyatta',4,50,0,150,'Tekhartha Zenyatta',20,172,'The Shambali','Shambali Monastery, Nepal',3,'Zenyatta calls upon orbs of harmony and discord to heal his teammates and weaken his opponents, all while pursuing a transcendent state of immunity to damage.');
